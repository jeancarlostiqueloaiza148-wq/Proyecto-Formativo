      ...
      <main className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-orange-50">
        ...
        <section className="text-center py-20 px-6">
          ...
          <p className="max-w-3xl mx-auto mt-6 text-gray-600 text-lg">
            Conoce el equipo encargado del desarrollo de OVIADSO, una
            plataforma creada para optimizar la gestión de la unidad ovina del
        ...
        <section className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            <p className="text-lg text-gray-600 leading-8">
              ...
              proceso formativo del SENA, donde aplicamos nuestros
              conocimientos y habilidades para construir una solución
              tecnológica enfocada en mejorar la gestión de la unidad ovina y
              facilitar la toma de decisiones mediante información organizada y
              confiable.
            </p>
          </div>
          ...
          <section className="max-w-5xl mx-auto text-center mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
              <img
                src="/ovino1.jpeg"
                alt="Unidad ovina"
                className="rounded-2xl shadow-lg hover:scale-105 transition h-40 w-full object-cover"
              />
          ...
          <section className="max-w-4xl mx-auto text-center py-10 mb-16">
            <div className="bg-gradient-to-r from-orange-500 to-amber-500 text-white p-10 rounded-3xl shadow-xl">
              ...
              <p className="text-lg">
                ...
                organización y análisis de información para una mejor toma de
                decisiones.
              </p>
            </div>
          </section>
