CREATE DATABASE  IF NOT EXISTS `proyecto oviadso` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `proyecto oviadso`;
...
INSERT INTO `births` VALUES (1,'2026-07-16','3','1','Saludable','Se realizó revisión veterinaria',1,'El cordero nació sin complicaciones y permanece con la madre.','2026-07-18 01:35:20','2026-07-18 01:38:29'),(2,'2026-07-19','2','5','Saludable','Se realizó limpieza y revisión veterinaria',1,'Nacimiento sin complicaciones','2026-07-20 00:26:56','2026-07-20 00:33:02'),(3,'2026-07-19','4','2','Saludable','Se realizó limpieza y revisión veterinaria',1,'Nacimiento sin complicaciones','2026-08-21 16:26:13','2026-08-21 16:26:13'),(4,'2026-07-19','5','2','Saludable','Se realizó limpieza y revisión veterinaria',1,'Nacimiento sin complicaciones','2026-08-21 16:27:24','2026-08-21 16:27:24');
...
INSERT INTO `ovines` VALUES (1,'Luna','OV-001','Pelibuey','H','2025-03-10',36,'Saludable',1,'2026-07-16 00:13:53','2026-07-16 00:14:57'),(2,'Estrella','OV-002','Dorper','Hembra','2025-04-12',38,'Saludable',1,'2026-07-20 01:19:52','2026-07-20 01:20:51'),(3,'Oveja Prueba','OV001','Dorper','Hembra','2026-08-09',45,'Activo',1,'2026-08-09 21:49:12','2026-08-09 21:49:12');
...
INSERT INTO `responsibles` VALUES (1,'Sofia','Cardenas','1023456789','Instructora',1,'3101234567','sofia.cardenas.nuevo@gmail.com','2026-07-15 21:40:47','2026-07-15 21:40:47',NULL,NULL),(2,'Carlos','Ramírez','1023456789','Veterinario',1,'3204567890','carlos.ramirez@gmail.com','2026-07-15 21:42:00','2026-07-20 01:24:43',NULL,NULL),(3,'Carlos','Ramírez','1023456789','Veterinario',1,'3204567890','carlos.ramirez@gmail.com','2026-07-20 01:22:56','2026-07-20 01:22:56',NULL,NULL);
...
CREATE TABLE `roll` (
  ...
  `id_app_route` varchar(45) NOT NULL,
  `is_pasante` tinyint NOT NULL DEFAULT '1',
  `is_superadmin` tinyint NOT NULL DEFAULT '1',
  `is_gestor` tinyint NOT NULL DEFAULT '1',
  `is_admin` tinyint NOT NULL DEFAULT '1',
  `is_instructor` tinyint NOT NULL DEFAULT '1',
  `is_aprendiz` tinyint NOT NULL DEFAULT '1',
...
INSERT INTO `users` VALUES (1,'Jean','jean1@prueba.com','$2b$10$/VuGJDlT20i/MB/61UYMI.n0V.gz.qnBtIVsQQgTv6jLdGTOhgfHm','Administrador','Ingeniero',0,1,1,'123456789','2026-08-01 18:04:32','2026-08-09 20:43:31',NULL,NULL,'',NULL),(2,'Jean','jean2@prueba.com','123456','Administrador','Ingeniero',0,1,1,'123456789','2026-08-02 13:55:39','2026-08-02 13:55:39',NULL,NULL,'',NULL),(3,'Jean','jean3@prueba.com','123456','Administrador','Ingeniero',0,1,1,'123456789','2026-08-03 03:12:44','2026-08-03 03:12:44',NULL,NULL,'',NULL),(4,'Jean','jean4@prueba.com','123456','Administrador','Ingeniero',0,1,1,'123456789','2026-08-03 12:25:36','2026-08-03 12:25:36',NULL,NULL,'',NULL),(5,'Jean','jean5@prueba.com','123456','Administrador','Ingeniero',0,1,1,'123456789','2026-08-03 16:10:13','2026-08-03 16:10:13',NULL,NULL,'',NULL);
...
-- Dump completed on 2026-08-23 21:42:08
